...
export type StageProgress = { id: string; name: string; done: boolean };
export type LoiProgress = { id: string; name: string; stages: StageProgress[] };
export type UoiProgress = { id: string; name: string; lois: LoiProgress[] };
